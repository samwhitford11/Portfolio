...
const Home = () => {
    return (
        <div name='home'className='w-full h-screen bg-[#17232c]'>
            {/* Container  */}
            <div className='max-w-[1000px] mx-auto px-12 flex flex-col justify-center h-full pt-20'>
                ...
                <p className='text-[#8892b0] py-4 max-w-[700px]'>I’m a Software Engineer with experience in project management and web development looking to apply my creative mindset to build uniquely stunning applications.<img className='rounded-full w-96 h-96 w-32 h-32 pt-3 pb-3' src={Profile} alt="profile pic"></img></p>
                <div>
